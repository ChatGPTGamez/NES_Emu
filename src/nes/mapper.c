...
Mapper* MapperMMC1_Create(Cart* cart);  // implemented in mapper_mmc1.c
Mapper* MapperUxROM_Create(Cart* cart); // implemented in mapper_uxrom.c
...
Mapper* Mapper_Create(Cart* cart, u32 mapper_id)
{
    ...
    switch (mapper_id) {
        ...
        case 1: return MapperMMC1_Create(cart);
        case 2: return MapperUxROM_Create(cart);
        default:
